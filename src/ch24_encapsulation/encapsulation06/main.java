...
public static void main(String[] args) {
    ...
    employee emplooyess=new employee(name,salary,dob);
    System.out.println("emplooyess = " + emplooyess);

    int age=emplooyess.agecalculator(dob);
    if (age>18){
        System.out.println("Welcome to our company Fernando your salary is 80000");
    }
    if (age<18){
        System.out.println("come back when you are 18 years old. yazdırınız.");
        if (age==18){
            System.out.println("we can have inter with you after that you can have a 80000");
        }
    }
}}
class employee {
