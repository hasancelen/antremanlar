...
public class Islemler {
    ...
    static String kisiTuru;//yukarıdaki yapılar her method için"**********************************      \nOGRENCI VE OGRETMEN ANA MENU \n**********************************\n1- OGRENCI ISLEMLERI\n2- OGRETMEN ISLEMLERI\nQ- CIKIS \nLutfen yapmak istediginiz islemi giriniz : "); call edilmesi için static tanımlandı.

    public static void girisPaneli() {


        String seçim = input.next().toUpperCase();//kullanıcının secim girdisi byk harf atandı
        switch (seçim) {
            case "1":
